    ...
    const prismjs = function (global, module, exports) {
      ...
      (function (Prism) {
        ...
        var keywordKinds = {
          ...
          contextual: 'add alias and ascending async await by descending from(?=\\s*(?:\\w|$)) get global group into init(?=\\s*;) join let nameof not notnull on or orderby includes remove select set unmanaged value when where with(?=\\s*{)',

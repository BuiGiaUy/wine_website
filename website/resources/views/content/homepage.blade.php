            ...
            <div uk-slider>
                <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
                    <ul class="uk-slider-items uk-child-width-1-2@s uk-child-width-1-1@m">
                        <li>
                            <img  src="https://winecellar.vn/wp-content/uploads/2022/04/banner-vang-trang-0.jpg" alt="Image 1">
                        </li>
                        <li>
                            <img src="https://winecellar.vn/wp-content/uploads/2022/04/banner-vang-trang-0.jpg" alt="Image 2">
                        </li>
                        <li>
                            <img src="https://winecellar.vn/wp-content/uploads/2022/04/banner-vang-trang-0.jpg" alt="Image 3">
                        </li>
                        <li>
                            <img src="https://winecellar.vn/wp-content/uploads/2022/04/banner-vang-trang-0.jpg" alt="Image 4">
                        </li>
                        <li>
                            <img src="https://winecellar.vn/wp-content/uploads/2022/04/banner-vang-trang-0.jpg" alt="Image 5">
                        </li>
                    </ul>

                    <a class="uk-position-center-left uk-position-small uk-hidden-hover custom-nav" href="#" uk-slidenav-previous uk-slider-item="previous"></a>
                    <a class="uk-position-center-right uk-position-small uk-hidden-hover custom-nav" href="#" uk-slidenav-next uk-slider-item="next"></a>
        ...
        <div class="uk-background-cover uk-padding" style="background-color: #990d23;">
            <div class="">
                <div id="text-1504872352" class="uk-text-center uk-text-white">
                    <h1 class="uk-margin-remove uk-heading-small uk-text-uppercase uk-text-large	" ><strong>Winecellar.vn – We are master of wine</strong></h1>
        ...
        <div class="uk-padding-remove">
            <div class="uk-grid-collapse uk-child-width-1-4@m uk-child-width-1-2@s	" uk-grid>
                <div>
                    <div class="uk-card uk-card-hover uk-card-body uk-text-center ">
                        <div class="uk-card-media-top" style="width:20%; margin: 0 auto;">
                            <img src="https://winecellar.vn/wp-content/uploads/2022/03/champagne-1.png" width="80" height="80" alt="">
                        </div>
                ...
                <div>
                    <div class="uk-card uk-card-hover uk-card-body uk-text-center">
                        <div class="uk-card-media-top" style="width:20%; margin: 0 auto;">
                            <img src="https://winecellar.vn/wp-content/uploads/2023/06/gh-toan-quoc.png" width="42" height="43" alt="">
                        </div>
                ...
                <div>
                    <div class="uk-card uk-card-hover uk-card-body uk-text-center">
                        <div class="uk-card-media-top" style="width:20%; margin: 0 auto;">
                            <img src="https://winecellar.vn/wp-content/uploads/2022/03/delivery-1.png" width="80" height="80" alt="">
                        </div>
                        <div class="uk-card-body uk-padding-remove">
                            <h4><span style="color: #800000;">GIAO HÀNG NHANH (2H)</span></h4>
                            <p><span style="font-size: 80%;">Miễn phí giao hàng tại<br> Hà Nội, Đà Nẵng, Nha Trang, Hồ Chí Minh, Phú Quốc</span></p>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="uk-card uk-card-hover uk-card-body uk-text-center">
                        <div class="uk-card-media-top" style="width:20%; margin: 0 auto;">
                            <img src="https://winecellar.vn/wp-content/uploads/2023/06/check-correct.png" width="48" height="48" alt="">
                        </div>
                        <div class="uk-card-body uk-padding-remove">
                            <h4><span style="color: #800000;">CAM KẾT CHẤT LƯỢNG</span></h4>
                            <p><span style="font-size: 80%;">Sản phẩm nhập nguyên chai, chính hãng,<br> từ thương hiệu uy tín.</span></p>
                        </div>
                    </div>
                </div>
            </div>
...
{{--                                {{ route('post.show', ['slug' => $post->slug]) }}--}}
                ...
                <div class="uk-flex uk-flex-center">
                    <div class="uk-width-3-5@s uk-padding">
                        <div class="uk-text-center">
                            <h2 class="uk-heading-medium uk-text-bold uk-margin-remove-top uk-text-large" style="color: #990d23;">Bạn tìm gì hôm nay?</h2>
                        </div>
                        <div class="uk-child-width-1-1 uk-child-width-1-4@m uk-grid-match" uk-grid>
                            <div class="uk-width-1-1">
                                <form action="https://winecellar.vn/cua-hang-ruou-vang/" id="quick_search" method="get" class="uk-form-stacked">
                                    <!-- Your form content here -->
                                    <input type="search" id="woocommerce-product-search-field-2" class="uk-border-rounded uk-input" placeholder="Hãy thử 'vang cá chép' xem sao!" value="" name="s">
                                </form>
                            </div>
                            <div class="uk-width-1-1 uk-margin-remove-top">
                                <div class="uk-flex uk-flex-wrap uk-margin-top uk-margin-bottom">
                                    <a href="https://winecellar.vn/ruou-vang-phap/" class="uk-button uk-button-secondary uk-button-small uk-border-pill uk-margin-small-right">Vang Pháp</a>
                                    <a href="https://winecellar.vn/ruou-vang-my/" class="uk-button uk-button-secondary uk-button-small uk-border-pill uk-margin-small-right">Vang Mỹ</a>
                                    <a href="https://winecellar.vn/ruou-vang-y/" class="uk-button uk-button-secondary uk-button-small uk-border-pill uk-margin-small-right">Vang Ý</a>
                                    <a href="https://winecellar.vn/ruou-vang-phap/" class="uk-button uk-button-secondary uk-button-small uk-border-pill uk-margin-small-right">Vang Pháp</a>
                                    <a href="https://winecellar.vn/ruou-vang-my/" class="uk-button uk-button-secondary uk-button-small uk-border-pill uk-margin-small-right">Vang Mỹ</a>
                                    <a href="https://winecellar.vn/ruou-vang-y/" class="uk-button uk-button-secondary uk-button-small uk-border-pill uk-margin-small-right">Vang Ý</a>
                                    <a href="https://winecellar.vn/ruou-vang-phap/" class="uk-button uk-button-secondary uk-button-small uk-border-pill uk-margin-small-right">Vang Pháp</a>
    ...
    <section class="uk-section uk-section-primary uk-padding" id="section_2140810014" style="background: #9d7623; color: #0A0A0A">
        <div class="">
            <h2 class="uk-text-large uk-text-center uk-margin-remove-top uk-margin-remove-bottom">KHÁM PHÁ THƯƠNG HIỆU</h2>
        ...
        <div class="uk-grid uk-child-width-1-2@m" uk-grid>
            <div class="uk-width-2-3@m uk-flex uk-flex-middle">
                <div class="uk-position-relative uk-light uk-background-cover uk-height-1-1">
                    <img src="https://winecellar.vn/wp-content/uploads/2023/11/hop-qua-tang-doanh-nghiep-phu-quy-doan-vien-chim-tri-banner-1400x510.jpg" class="uk-border-rounded" alt="" uk-cover>
                </div>
            </div>
            <div class="uk-width-1-3@m">
                <div class="uk-margin menu-services uk-height-1-1">
                    <ul class="uk-nav uk-nav-default uk-flex-column uk-height-1-1 uk-child-height-1-4@m uk-flex uk-flex-center">
                        <li class="uk-height-1-4"><a href="https://winecellar.vn/qua-tang-doanh-nghiep/"><i class="uk-icon uk-margin-small-right icon-user-o"></i> Khách hàng doanh nghiệp</a></li>
                        <li class="uk-height-1-4"><a href="https://winecellar.vn/qua-tang-doanh-nghiep/"><i class="uk-icon uk-margin-small-right icon-gift"></i> Quà tặng doanh nghiệp</a></li>
                        <li class="uk-height-1-4"><a href="https://winecellar.vn"><i class="uk-icon uk-margin-small-right icon-star"></i> Tư vấn quà tặng</a></li>
                        <li class="uk-height-1-4"><a href="https://winecellar.vn"><i class="uk-icon uk-margin-small-right icon-menu"></i> Đào tạo</a></li>
                    </ul>
                </div>
            </div>
        </div>

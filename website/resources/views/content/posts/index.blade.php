...
@section('content')
    <header class="uk-background-cover uk-background-center-center uk-position-relative " data-src="https://winecellar.vn/wp-content/uploads/2022/04/pinot-noir-banner.jpg" uk-img style="margin-bottom: 40px">
            ...
            @foreach ($posts as $post)
                ...
                <div class="uk-card  uk-card-hover ">
                    ...
                    <div class="uk-padding-small">
                        <a href="{{ route('posts.show', ['post' => $post->slug]) }}"  style="text-decoration: none;">

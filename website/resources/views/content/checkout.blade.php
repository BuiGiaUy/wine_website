                ...
                <div class="uk-flex uk-flex-wrap uk-flex-middle">
                    <nav class="uk-breadcrumb uk-width-1-1 uk-flex-center uk-text-center uk-margin-remove">
                        <ul class="uk-breadcrumb">
                            <li>
                                <a href="https://winecellar.vn/cart/" class="uk-text-large">
                                    <span class="breadcrumb-step uk-visible@m">1</span> Giỏ hàng
                                </a>
                            </li>
                            <li>
                                <a href="https://winecellar.vn/checkout/" class="uk-text-large uk-active">
                    ...
                    <div class="uk-width-2-5@m">
                        <div class="card uk-card-default uk-card-body">
                            ...
                            <table class="uk-table uk-table-divider">
                                ...
                                <tbody>
                                <tr>
                                    <td>Rượu Whisky Glengoyne 10 Year Old <strong>× 1</strong></td>

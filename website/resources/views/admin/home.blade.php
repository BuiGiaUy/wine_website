            ...
            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="box p-5">
                                    <div class="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"></path>
                                        </svg>
                                        <div class="ml-auto">
                ...
                <div class="col-span-12 lg:col-span-6 mt-8">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="report-chart">
                            <div class="h-[275px]">
                                <canvas id="report-line-chart" class="mt-6 -mb-6" width="496" height="343"
                                        style="display: block; box-sizing: border-box; height: 274.4px; width: 396.8px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
                    ...
                    <div class="intro-y box p-5 mt-5">
                        <div class="mt-3">
                            <div class="h-[213px]">
                                <canvas id="report-pie-chart" width="208" height="266"
                                        style="display: block; box-sizing: border-box; height: 212.8px; width: 166.4px;"></canvas>
                            </div>
                        </div>
                ...
                <div class="col-span-12 xl:col-span-8 mt-6">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="report-maps mt-5 bg-slate-200 rounded-md" data-center="-6.2425342, 106.8626478"
                             data-sources="/dist/json/location.json" style="position: relative; overflow: hidden;">
                            <div
                                ...
                                <div class="gm-err-container">
                                    <div class="gm-err-content">
                                        ...
                                        <div class="gm-err-message">Trang này đã không tải Google Maps đúng cách. Hãy
                                            xem bảng điều khiển JavaScript để biết chi tiết kỹ thuật.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-span-12 grid grid-cols-12 gap-6 mt-8">
                    ...
                    <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
                        <div class="box p-5 zoom-in">
                            ...
                            <div class="mt-1">
                                <div class="h-[58px]">
                                    <canvas class="simple-line-chart-1 -ml-1" width="213" height="72"
                                            style="display: block; box-sizing: border-box; height: 57.6px; width: 170.4px;"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-slate-500 mt-1">Has changed <a class="text-primary" href="">Sony
                                            Master Series A9G</a> price and description
                                    </div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-slate-500 mt-1">Has changed <a class="text-primary" href="">Samsung
                                            Galaxy S20 Ultra</a> description
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="intro-x flex items-center h-10">
                            ...
                            <button data-carousel="important-notes" data-target="prev"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                     stroke-linejoin="round" icon-name="chevron-left" data-lucide="chevron-left"
                        ...
                        <div class="mt-5 intro-x">
                            <div class="box zoom-in">
                                <div class="tns-outer" id="important-notes-ow">
                                    <button type="button" data-action="stop"><span class="tns-visually-hidden">stop animation</span>stop
                                    </button>
                                    <div class="tns-liveregion tns-visually-hidden" aria-live="polite"
                                         aria-atomic="true">slide <span class="current">2</span> of 3
                                    </div>
                                    <div id="important-notes-mw" class="tns-ovh">
                                        <div class="tns-inner" id="important-notes-iw">
                                            <div
                                                class="tiny-slider  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                                id="important-notes"
                                                ...
                                                <div class="p-5 tns-item" id="important-notes-item1" aria-hidden="true"
                                                     tabindex="-1">
                                                    <div class="text-base font-medium truncate">Lorem Ipsum is simply
                                                        dummy text
                                                    </div>
                                                ...
                                                <div class="p-5 tns-item" id="important-notes-item2" aria-hidden="true"
                                                     tabindex="-1">
                                                    <div class="text-base font-medium truncate">Lorem Ipsum is simply
                                                        dummy text
                                                    </div>

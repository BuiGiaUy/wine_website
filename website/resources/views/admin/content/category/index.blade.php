        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                @foreach ($categories as $category)
                        ...
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="{{ $category->name }}" class="tooltip rounded-full"
                                         src="{{ asset('path/to/image.jpg') }}"
                                         title="Uploaded at {{ $category->created_at }}">
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <a class="flex items-center text-danger" href="javascript:;" data-tw-toggle="modal"
                                   data-tw-target="#delete-confirmation-modal-{{ $category->id }}">
                    ...
                    <div id="delete-confirmation-modal-{{ $category->id }}" class="modal" tabindex="-1"
                         aria-hidden="true">

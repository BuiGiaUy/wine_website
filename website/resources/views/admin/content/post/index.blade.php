...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('admin.post.add') }}" class="btn btn-primary shadow-md mr-2">Add New Post</a>
            <div class="dropdown">
            ...
            <table class="table table-report -mt-2">
                ...
                @foreach($posts as $post)
                    <tr class="intro-x">
                        ...
                        <td>
                            <a href="{{ route('admin.post.index', $post->id) }}" class="font-medium whitespace-nowrap">{{ $post->name }}</a>
                            <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ Str::limit($post->description, 50) }}</div>
                        </td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{ route('admin.post.edit', $post->id) }}">

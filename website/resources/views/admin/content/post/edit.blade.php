            ...
            <form action="{{ route('admin.post.update', $post->id) }}" method="Post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" class="form-input w-full" value="{{ $post->slug }}" placeholder="Enter slug...">
                    </div>
                    <!-- Upload Image -->
                    {{--                    <div class="col-span-2">--}}
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" class="form-textarea w-full" rows="4" placeholder="Enter description...">{{ $post->description }}</textarea>
                    </div>
                    <!-- Content -->
                    <div class="col-span-2">
                        <label for="content" class="block text-gray-700 font-medium mb-2">Content</label>
                        <textarea name="content" id="content" class="form-textarea w-full" rows="8" placeholder="Enter content...">{{ $post->content }}</textarea>
                    </div>
